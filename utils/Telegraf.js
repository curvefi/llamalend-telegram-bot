...
const HELP_TEXT = `@LlamalendMonitorBot allows you to view loan information from [Curve Lend](https://curve.finance/lend/) and [crvUSD](https://curve.finance/crvusd/) for any address you want; it’ll also notify you of important changes to these loans’ health statuses\\.
